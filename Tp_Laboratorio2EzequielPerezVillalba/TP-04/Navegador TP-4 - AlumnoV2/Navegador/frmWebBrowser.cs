    ...
    public partial class frmWebBrowser : Form
    {
        ...
        private void btnIr_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                descargador.pdd += new Descargador.ProgresoDeDescarga(this.ProgresoDescarga);
                descargador.dc+= new Descargador.DescargaCompleta(this.FinDescarga);
        ...
        public void IrA(string dir)
        {
            this.txtUrl.Text = dir;
